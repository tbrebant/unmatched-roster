...
class App extends DoDom {
  ...
  async init () {
    ...
    chapter.addDomText(' fighters released up to the present day (March 2026 at the time of writing). If you notice some missing or erroneous information, please read this: ');
